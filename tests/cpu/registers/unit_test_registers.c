...
static bool test_core_register(
    word         (*reg_get)(void),
...
static bool test_virtual_register(
    byte         (*reg_get)(void),
...
static bool test_register_composition(
...
static bool test_core_register_AF(void) {
    return test_core_register(
        registers_get_AF, registers_set_AF, offsetof(struct registers, AF), 0xFFF0
    );
}

static bool test_core_register_BC(void) {
    return test_core_register(
        registers_get_BC, registers_set_BC, offsetof(struct registers, BC), 0xFFFF
    );
}

static bool test_core_register_DE(void) {
    return test_core_register(
        registers_get_DE, registers_set_DE, offsetof(struct registers, DE), 0xFFFF
    );
}

static bool test_core_register_HL(void) {
    return test_core_register(
        registers_get_HL, registers_set_HL, offsetof(struct registers, HL), 0xFFFF
    );
}

static bool test_core_register_SP(void) {
    return test_core_register(
        registers_get_SP, registers_set_SP, offsetof(struct registers, SP), 0xFFFF
    );
}

static bool test_core_register_PC(void) {
    return test_core_register(
        registers_get_PC, registers_set_PC, offsetof(struct registers, PC), 0xFFFF
    );
}
...
static bool test_virtual_register_A(void) {
    return test_virtual_register(
        registers_get_A, registers_set_A, offsetof(struct registers, A), 0xFF
    );
}

static bool test_virtual_register_F(void) {
    return test_virtual_register(
        registers_get_F, registers_set_F, offsetof(struct registers, F), 0xF0
    );
}

static bool test_virtual_register_B(void) {
    return test_virtual_register(
        registers_get_B, registers_set_B, offsetof(struct registers, B), 0xFF
    );
}

static bool test_virtual_register_C(void) {
    return test_virtual_register(
        registers_get_C, registers_set_C, offsetof(struct registers, C), 0xFF
    );
}

static bool test_virtual_register_D(void) {
    return test_virtual_register(
        registers_get_D, registers_set_D, offsetof(struct registers, D), 0xFF
    );
}

static bool test_virtual_register_E(void) {
    return test_virtual_register(
        registers_get_E, registers_set_E, offsetof(struct registers, E), 0xFF
    );
}

static bool test_virtual_register_H(void) {
    return test_virtual_register(
        registers_get_H, registers_set_H, offsetof(struct registers, H), 0xFF
    );
}

static bool test_virtual_register_L(void) {
    return test_virtual_register(
        registers_get_L, registers_set_L, offsetof(struct registers, L), 0xFF
    );
}
...
static bool test_flag_z(void) {
    return test_flag(registers_get_flag_z, registers_set_flag_z, registers_clear_flag_z, 7);
}

static bool test_flag_n(void) {
    return test_flag(registers_get_flag_n, registers_set_flag_n, registers_clear_flag_n, 6);
}

static bool test_flag_h(void) {
    return test_flag(registers_get_flag_h, registers_set_flag_h, registers_clear_flag_h, 5);
}

static bool test_flag_c(void) {
    return test_flag(registers_get_flag_c, registers_set_flag_c, registers_clear_flag_c, 4);
}
